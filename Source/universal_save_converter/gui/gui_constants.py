...
CONSOLE_LOGO_SIZE = (250, 80)

# Button Size (Abscent of Logo)
BRAND_BUTTON_SIZE = (180,50)
CONSOLE_BUTTON_SIZE = (290,70)
BACK_BUTTON_SIZE = (230,40)
ARROW_BUTTON_WIDTH = 2
ARROW_BUTTON_HEIGHT = 3

# Logo Padding
BRAND_LOGO_PADDING_X = 10 #width
BRAND_LOGO_PADDING_Y = 22 #height
CONSOLE_LOGO_PADDING_X = 5   #width
CONSOLE_LOGO_PADDING_Y = 4   #height

# Button Padding
BRAND_BUTTON_PADDING_X = 10 #width
BRAND_BUTTON_PADDING_Y = 12 #height
CONSOLE_BUTTON_PADDING_X = 10   #width
CONSOLE_BUTTON_PADDING_Y = 12   #height

# Arrow Padding
ARROW_HORIZONTAL_PADDING = 0.01

CONSOLE_CANVAS_WIDTH = CONSOLE_LOGO_SIZE[0] + CONSOLE_LOGO_PADDING_X * 20  # width
CONSOLE_CANVAS_HEIGHT = CONSOLE_LOGO_SIZE[1] + CONSOLE_LOGO_PADDING_Y * 1  # height
TEXT_BUTTON_WIDTH = 37
TEXT_BUTTON_HEIGHT = 2
LOGO_HOVER_SIZE = (300, 80)
